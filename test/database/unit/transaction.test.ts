...
//             if (checkIsGray()) {
//                 assert.deepStrictEqual(doc.data[0], data[0])
//             } else {
//                 assert.deepStrictEqual(doc.data, data[0])
//             }
//         })
...
//             .doc('1')
//             .get()
//         assert.deepStrictEqual(doc.data[0], {
//             ...data[0],
//             date,
//             category: 'Node.js'
//         })
...
//         assert(updateResult.upserted.length > 0)
...
//         // const docRef = db.collection(collectionName).doc('2')
//         const transaction = await db.startTransaction()
//         // let doc = await t∏ransaction.get(docRef)
//         let doc = await transaction
//             .collection(collectionName)
//             .doc('2')
//             .get()
//         assert.deepStrictEqual(doc.data[0], data[1])
...
//             .get()
//         assert.deepStrictEqual(result.data[0], data[0])
//         assert.deepStrictEqual(doc_new.data[0], {
//             ...data[0],
//             category: 'update in transaction'
//         })
...
//         assert.deepStrictEqual(snapshot1.data[0], data[0])
//         assert.deepStrictEqual(snapshot2.data[0], data[1])
