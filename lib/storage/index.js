...
async function uploadFile(cloudbase, { cloudPath, fileContent }, opts) {
    ...
    if (body && body.Error) {
        ...
        if (code === 'SignatureDoesNotMatch') {
            throw utils_1.E(Object.assign(Object.assign({}, code_1.ERROR.SYS_ERR), { message }));
        }
        throw utils_1.E(Object.assign(Object.assign({}, code_1.ERROR.STORAGE_REQUEST_FAIL), { message }));
    }
    return {
        fileID: fileId
    };
...
async function deleteFile(cloudbase, { fileList }, opts) {
    if (!fileList || !Array.isArray(fileList)) {
        throw utils_1.E(Object.assign(Object.assign({}, code_1.ERROR.INVALID_PARAM), { message: 'fileList必须是非空的数组' }));
    }
    for (let file of fileList) {
        if (!file || typeof file !== 'string') {
            throw utils_1.E(Object.assign(Object.assign({}, code_1.ERROR.INVALID_PARAM), { message: 'fileList的元素必须是非空的字符串' }));
        }
    }
    let params = {
    ...
    for (let file of fileList) {
        if (typeof file === 'object') {
            if (!file.hasOwnProperty('fileID') || !file.hasOwnProperty('maxAge')) {
                throw utils_1.E(Object.assign(Object.assign({}, code_1.ERROR.INVALID_PARAM), { message: 'fileList的元素如果是对象，必须是包含fileID和maxAge的对象' }));
            }
            file_list.push({
                fileid: file.fileID,
                max_age: file.maxAge
            ...
            throw utils_1.E(Object.assign(Object.assign({}, code_1.ERROR.INVALID_PARAM), { message: 'fileList的元素如果不是对象，则必须是字符串' }));
        }
    }
    let params = {
...
async function getUploadMetadata(cloudbase, { cloudPath }, opts) {
    ...
    if (res.code) {
        throw utils_1.E(Object.assign(Object.assign({}, code_1.ERROR.STORAGE_REQUEST_FAIL), { message: 'get upload metadata failed: ' + res.code }));
    }
    else {
        return res;
    }
