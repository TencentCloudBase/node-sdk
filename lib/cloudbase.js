...
class CloudBase {
     ...
     * @param opts
     */
    callWxOpenApi({ apiName, cgiName, requestData }, opts) {
        return wx_1.callWxOpenApi(this, { apiName, cgiName, requestData }, opts);
    }
    /**
     * wxpayapi调用
     *
     ...
     * @param opts
     */
    callWxPayApi({ apiName, cgiName, requestData }, opts) {
        return wx_1.callWxPayApi(this, { apiName, cgiName, requestData }, opts);
    }
    /**
     * 微信云调用
     *
     ...
     * @param opts
     */
    callCompatibleWxOpenApi({ apiName, cgiName, requestData }, opts) {
        return wx_1.callCompatibleWxOpenApi(this, { apiName, cgiName, requestData }, opts);
    }
    /**
     * 上传文件
     *
