 ...
 */
export async function uploadFile(cloudbase: CloudBase, { cloudPath, fileContent }, opts?: ICustomReqOpts): Promise<IUploadFileRes> {
  const {
 ...
 */
export async function deleteFile(cloudbase: CloudBase, { fileList }, opts?: ICustomReqOpts): Promise<ICustomErrRes | IDeleteFileRes> {
 ...
 */
export async function getTempFileURL(cloudbase: CloudBase, { fileList }, opts?: ICustomReqOpts): Promise<ICustomErrRes | IGetFileUrlRes>  {
  if (!fileList || !Array.isArray(fileList)) {
    throw E({
      ...ERROR.INVALID_PARAM,
      message: 'fileList必须是非空的数组'
...
export async function downloadFile(cloudbase: CloudBase, params : { fileID:string, tempFilePath?: string }, opts?: ICustomReqOpts ): Promise<ICustomErrRes | IDownloadFileRes> {
  let tmpUrl
...
export async function getUploadMetadata(cloudbase: CloudBase, { cloudPath }, opts?: ICustomReqOpts ) {
  let params = {
