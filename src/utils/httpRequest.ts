...
export class Request {
  ...
  private defaultEndPoint: string = 'tcb-admin.tencentcloudapi.com'
  private inScfHost: string = 'tcb-admin.tencentyun.com'
  // private openApiHost: string = 'tcb-open.tencentcloudapi.com'
  private urlPath: string = '/admin'
  ...
  public getOpts(): IReqOpts {
    ...
    let params: ICustomParam = Object.assign({}, args.params, {
...
export default async (args: IRequestInfo): Promise<any> => {
  ...
  if (reqHooks) {
    return await baseRequest(reqOpts, reqHooks)
  }
